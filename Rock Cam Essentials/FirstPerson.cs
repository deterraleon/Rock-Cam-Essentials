...
namespace Rock_Cam_Essentials
{
    ...
    public class FirstPerson
    {
        ...
        public float PositionalSmoothing {get => _CameraController._firstPersonStabilizer.PositionalSmoothing; set => SetPositionalSmooting(value); }
        public float RotationalSmoothing {get => _CameraController._firstPersonStabilizer.RotationalSmoothing; set => SetRotationalSmooting(value); }
